<?php
// source: C:\wamp\www\TypeValidator\app/templates/Homepage/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('3212509545', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lba934b79ceb_content')) { function _lba934b79ceb_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
<div id="content">
	...
	<h2>We hope you enjoy this framework!</h2>
        <h2><a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link("TestValidator:"), ENT_COMPAT) ?>
">Try my type validating!</a></h2>
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb12dc20873f_title')) { function _lb12dc20873f_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb7802c65b22_scripts')) { function _lb7802c65b22_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbe0d0404601_head')) { function _lbe0d0404601_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
