<?php
// source: C:\wamp\www\TypeValidator\app/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('3531586083', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb8997c4849d_head')) { function _lb8997c4849d_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lba1a8e36f0d_scripts')) { function _lba1a8e36f0d_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
